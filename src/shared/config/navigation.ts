...
export const adminNavItems: NavItem[] = [
  ...
  { id: "import", label: "Import", icon: Upload, route: "/tests/import", group: "main", order: 2 },
  { id: "flashcards", label: "Flashcard", icon: BookOpen, route: "/flashcards", group: "main", order: 3 },
  ...
  { id: "permissions", label: "Phân quyền", icon: ShieldCheck, route: "/modules", group: "system", superAdminOnly: true, order: 13 },
  { id: "settings", label: "Cài đặt", icon: Settings, route: "/settings", group: "system", superAdminOnly: true, order: 14 },
];
