...
export default function ScheduleSetupNotice({
  ...
  return (
    <div className="rounded-xl border border-amber-500/30 bg-amber-500/10 p-4 md:p-5 space-y-3">
      ...
      <div className="rounded-lg border bg-card px-3 py-2.5 text-xs text-muted-foreground flex items-center gap-2">
